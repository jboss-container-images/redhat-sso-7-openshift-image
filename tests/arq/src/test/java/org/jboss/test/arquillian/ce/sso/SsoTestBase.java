...
@OpenShiftDynamicImageStreamResource(name = "${imageStream.sso73.name:redhat-sso73-openshift}", image = "${imageStream.sso73.image:registry.access.redhat.com/redhat-sso-7/sso73-openshift:1.0}", version = "${imageStream.sso73.version:1.0}")
