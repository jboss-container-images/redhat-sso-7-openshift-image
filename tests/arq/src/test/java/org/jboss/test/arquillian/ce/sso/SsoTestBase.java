...
@OpenShiftDynamicImageStreamResource(
  name = "${imageStream.sso.name:sso76-openshift-rhel8}",
  image = "${imageStream.sso.image:registry.access.redhat.com/sso-7/sso76-openshift-rhel8:7.6}",
  version = "${imageStream.sso.version:7.6}"
)
