...
@test "inject_datasources: DATASOURCES - NONXA - URL - Explicit driver" {
    DATASOURCES="TEST"
    TEST_JNDI="java:/jboss/datasources/testds"
...
@test "inject_datasources: DB_SERVICE_PREFIX_MAPPING - XA - Host+Port+Database - Inferred driver" {
    DB_SERVICE_PREFIX_MAPPING="test-postgresql=TEST"
    TEST_JNDI="java:/jboss/datasources/testds"
    TEST_USERNAME="kermit"
    TEST_PASSWORD="thefrog"
...
@test "inject_datasources: DB_SERVICE_PREFIX_MAPPING - XA - Host+Port+Database - Explicit driver" {
    DB_SERVICE_PREFIX_MAPPING="test-driverisexplicit=TEST"
    TEST_DRIVER="postgresql"
    TEST_JNDI="java:/jboss/datasources/testds"
    TEST_USERNAME="kermit"
    TEST_PASSWORD="thefrog"
    TEST_NONXA="false"
    TEST_DRIVERISEXPLICIT_SERVICE_HOST="localhost"
    TEST_DRIVERISEXPLICIT_SERVICE_PORT="5432"
    TEST_DATABASE="postgresdb"

    run inject_datasources

    [ "$status" -eq 0 ]
    assert_datasources "prefix_postgresql_xa_explicit_driver.xml"
}

@test "inject_datasources: DB_SERVICE_PREFIX_MAPPING - XA - MySQL - Host+Port+Database - Inferred driver" {
...
@test "inject_datasources: DB_SERVICE_PREFIX_MAPPING - XA - MySQL - Host+Port+Database - Explicit driver" {
    DB_SERVICE_PREFIX_MAPPING="test-driverisexplicit=TEST"
    TEST_DRIVER="mysql"
    TEST_JNDI="java:/jboss/datasources/testds"
    TEST_USERNAME="kermit"
    ...
    [ "$status" -eq 0 ]
    assert_datasources "prefix_mysql_xa_explicit_driver.xml"
}
