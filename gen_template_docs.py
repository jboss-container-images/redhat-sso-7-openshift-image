...
LINKS =  { "redhat-sso72-openshift:1.4": "../../templates/sso-openshift{outfilesuffix}[`redhat-sso-7/sso72-openshift`]", }
...
def createTemplate(data, path):
    ...
    # special case: RH-SSO templates have additional description
